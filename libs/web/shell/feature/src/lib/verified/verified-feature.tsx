      ...
      <VerifiedSectionBuiltWith
        data={[
          ...
          // },
          {
            ...
            title: 'Gum',
            description:
              'Gum Protocol is used to verify ownership of Gum accounts like Profiles, Posts, and Comments. Gum Protocol is a Solana based protocol that allows users to verify their ownership of a Gum account.',
            link: 'https://gum.fun',
          },
          // {
...
export function VerifiedContentFeature({ page }: { page: string }) {
  return (
    <Container>
