...
export const AuthApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        requestChallenge: async (publicKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/auth/request-challenge/{publicKey}`
         ...
         * @throws {RequiredError}
         */
        respondChallenge: async (responseChallengeOptions: ResponseChallengeOptions, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            localVarRequestOptions.data = serializeDataIfNeeded(responseChallengeOptions, localVarRequestOptions, configuration)
...
export const AuthApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async requestChallenge(publicKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RequestChallenge>> {
         ...
         * @throws {RequiredError}
         */
        async respondChallenge(responseChallengeOptions: ResponseChallengeOptions, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
...
export class AuthApi extends BaseAPI implements AuthApiInterface {
    ...
    public requestChallenge(publicKey: string, options?: AxiosRequestConfig) {
        return AuthApiFp(this.configuration).requestChallenge(publicKey, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public respondChallenge(responseChallengeOptions: ResponseChallengeOptions, options?: AxiosRequestConfig) {
        return AuthApiFp(this.configuration).respondChallenge(responseChallengeOptions, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSolanaControllerBonfidaLookup: async (publicKey: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'publicKey' is not null or undefined
            assertParamExists('apiSolanaControllerBonfidaLookup', 'publicKey', publicKey)
            const localVarPath = `/api/solana/bonfida/lookup/{publicKey}`
                .replace(`{${"publicKey"}}`, encodeURIComponent(String(publicKey)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
         ...
         * @throws {RequiredError}
         */
        getAccount: async (address: string, network: NetworkType, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSolanaControllerBonfidaLookup(publicKey: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
         ...
         * @throws {RequiredError}
         */
        async getAccount(address: string, network: NetworkType, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Account>> {
...
export class DefaultApi extends BaseAPI implements DefaultApiInterface {
    ...
    public apiSolanaControllerBonfidaLookup(publicKey: string, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).apiSolanaControllerBonfidaLookup(publicKey, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getAccount(address: string, network: NetworkType, options?: AxiosRequestConfig) {
        return DefaultApiFp(this.configuration).getAccount(address, network, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const PageApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getPageById: async (pageId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/page/get-page-by-id/{pageId}`
...
export const PageApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getPageById(pageId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Page>> {
         ...
         * @throws {RequiredError}
         */
        async getPageByUrl(url: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Page>> {
...
export class PageApi extends BaseAPI implements PageApiInterface {
    ...
    public getPageById(pageId: string, options?: AxiosRequestConfig) {
        return PageApiFp(this.configuration).getPageById(pageId, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public getPageByUrl(url: string, options?: AxiosRequestConfig) {
        return PageApiFp(this.configuration).getPageByUrl(url, options).then((request) => request(this.axios, this.basePath));
    }
}
...
export const UserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
        ...
        getUserById: async (userId: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/user/get-user-by-id/{userId}`
         ...
         * @throws {RequiredError}
         */
        getUserByIdentity: async (providerId: string, provider: IdentityProvider, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
        ...
        getUserByUsername: async (username: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/user/get-user-by-username/{username}`
        ...
        meta: async (username: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            const localVarPath = `/api/user/meta/{username}`
                .replace(`{${"username"}}`, encodeURIComponent(String(username)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, DUMMY_BASE_URL);
            let baseOptions;
...
export const UserApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserByIdentity(providerId: string, provider: IdentityProvider, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
         ...
         * @throws {RequiredError}
         */
        async getUserByUsername(username: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
         ...
         * @throws {RequiredError}
         */
        async meta(username: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<User>> {
...
export class UserApi extends BaseAPI implements UserApiInterface {
    ...
    public getUserByIdentity(providerId: string, provider: IdentityProvider, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).getUserByIdentity(providerId, provider, options).then((request) => request(this.axios, this.basePath));
    }
    ...
    public meta(username: string, options?: AxiosRequestConfig) {
        return UserApiFp(this.configuration).meta(username, options).then((request) => request(this.axios, this.basePath));
    }
}
