/**
 * FIXME: Enabling this test causes the following error:
 *
 * .../node_modules/ed25519-keygen/hdkey.js:1
 * ({"Object.<anonymous>":function(module,exports,require,__dirname,__filename,jest){import { ed25519 } from '@noble/curves/ed25519';
 *                                                                                   ^^^^^^
 * SyntaxError: Cannot use import statement outside a module
 *
 *   3 | import { Keypair as SolanaKeypair, PublicKey as SolanaPublicKey } from '@solana/web3.js'
 *   4 | import * as bs58 from 'bs58'
 * > 5 | import { HDKey } from 'ed25519-keygen/hdkey'
 *     | ^
 */
